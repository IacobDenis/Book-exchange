...
export function Login() {
  ...
  function onSubmit(data) {
    ...
    login(data)
      .then(() => {
        ...
        navigate("/mainpage");
        toast.info("Welcome to the general channel");
      })
      .catch((err) => {
        // console.log("err", err);
  ...
  return (
    ...
    >
      <Typography sx={{ color: blue["A100"] }} variant="h2">
        Login
      </Typography>
      <Box
      ...
      >
        ...
        <Link
          style={{ fontFamily: "Inter", fontWeight: 700, fontSize: 18, color: blue["A100"] }}
          component={NavLink}
          to="/register"
          variant="contained"
        >
          You don't have an account? Register now! will only take 30 seconds.
        </Link>
      </Box>
    </Stack>
  );
